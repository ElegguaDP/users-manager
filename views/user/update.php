...
<div class="user-form">
    ...
    <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h4 class="pull-left"><i class="glyphicon glyphicon-phone "></i> Phones</h4>
                <button type="button" class="add-item btn btn-success btn-sm pull-right main-add"><i class="glyphicon glyphicon-plus"></i> Add</button>
            </div>
            <div class="clearfix"></div>
